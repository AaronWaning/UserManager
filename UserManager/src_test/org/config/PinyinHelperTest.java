...
public class PinyinHelperTest extends TestCase {
  public void testToTongyongPinyinStringArray() throws BadHanyuPinyinOutputFormatCombination {
    // any input of non-Chinese characters will return null
    {
    	System.out.println(PinyinHelper.toHanyuPinyinString("万松", new HanyuPinyinOutputFormat(), ""));
