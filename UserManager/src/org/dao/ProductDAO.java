...
public class ProductDAO extends BaseHibernateDAO {
	...
	public Product findById(java.lang.Integer id) {
		...
		try {
			Product instance = (Product) getSession().get("org.vo.Product", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Product> findByExample(Product instance) {
		...
		try {
			List<Product> results = (List<Product>) getSession()
					.createCriteria("org.vo.Product").add(create(instance))
					.list();
	...
	public List<Product> findByMemo(Object memo) {
		return findByProperty(MEMO, memo);
	}

	public List<Product> findByOrderNo(Object orderNo) {
